...
import com.project.sam.bargrocery.backend.Controllers.getLowPricesController;
...
public class MyItemServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        Items[] itemsList = JSON.getObjectMapper().readValue(req.getReader(), Items[].class);
        ...
        JSON.getObjectMapper().writeValue(resp.getWriter(), priceList);
    }
}
